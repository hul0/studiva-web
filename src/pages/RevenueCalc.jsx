...
const RevenueCalc = () => {
    ...
    // Calculation logic
    useEffect(() => {
        // Algorithm constants provided by user
        const adRev = 0.01;
        const salePrice = 1;
        const convRate = 0.1;

        // Calculation: (Daily Viewers * 30 days) * (Value per viewer)
        // Value per viewer = (10% buy @ 1) + (90% watch ads @ 0.01)
        const valuePerViewer = (salePrice * convRate) + (adRev * (1 - convRate));

        // Total revenue per month
        // We also factor in the notes per week as a multiplier of total content reach
    ...
    return (
        <div className="revenue-calc-page" ref={containerRef}>
            ...
            <div className="rev-container">
                <button className="rev-back-btn" onClick={handleBack}>
                ...
                <div className="rev-grid">
                    ...
                    <div className="rev-card rev-results">
                        ...
                        <button className="rev-cta-btn" onClick={() => window.location.href = '/dashboard'}>
                            START EARNING NOW
                        </button>
                    </div>
                </div>
