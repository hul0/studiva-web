...
/* ── Section component ───────────────────────────────── */
const TeamSection = ({ label, title, members, variant = 'default' }) => (
...
export default function Team() {
  ...
  useGSAP(() => {
    /* Section entrances */
    gsap.utils.toArray('.tm-section').forEach((section) => {
        ...
        <section className="tm-cta">
          <div className="tm-container tm-cta__inner">
            ...
            <div className="tm-cta__buttons">
              <button className="tm-btn tm-btn--primary" onClick={navCreator}>
                Become a Creator
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" />
                </svg>
              </button>
              <button className="tm-btn tm-btn--ghost" onClick={navHome}>
                ← Back to Home
              </button>
            </div>
          </div>
